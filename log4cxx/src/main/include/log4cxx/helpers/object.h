...
public:                                                                    \
    ...
    public:                                                                \
        ...
        virtual LogString getName() const { return LOG4CXX_STR(#object); } \
    };                                                                     \
...
#define BEGIN_LOG4CXX_CAST_MAP()                          \
    ...
    {                                                     \
        const void *object = 0;                           \
        if (&clazz == &helpers::Object::getStaticClass()) \
            return (const helpers::Object *)this;
